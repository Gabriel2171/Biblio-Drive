          ...
          <div class="col-md-5">
                    ...
                    Ajouter Membre
                        <?php
                            ...
                            $stmt1 = $connexion->prepare("SELECT * FROM utilisateur");// on selectionne tout les users
                            $stmt1->setFetchMode(PDO::FETCH_OBJ);
                            $stmt1->execute();
                        ?>
                    <form action="ajouter_membre.php" method="post"> <!-- action sur la page -->
                    ...
                    mel: <input type="text" placeholder="(saisir le mel )"class="form-control" name="mel" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" /><br>
